...
class Styles {
  ...
  static Color Teal = Color.fromARGB(255, 0, 173, 181);
  static Color Black = Color.fromARGB(255, 34, 40, 49);

  static Color Dark = Color.fromARGB(255, 57, 62, 70);
  static Color Red = Color.fromARGB(255, 210, 73, 105);
